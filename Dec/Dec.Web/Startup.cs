...
using Dec.Logic.Mapping;
using Dec.Logic.Mediator.Handlers.QueryHandlers;
using Dec.Web.Infrastructure;
...
namespace Dec.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentityCore<AppIdentityPerson>()
                .AddDefaultTokenProviders()
                .AddUserStore<AppIdentityPersonStore>()
                .AddUserManager<AppIdentityPersonManager>()
            ...
            services.AddMediatR(typeof(GetPersonByIdQueryHandler)); // handlers are stored in the Dec.Logic assembly
